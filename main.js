...
function scor(N1, N2, N3) {
   titel.html(`${box[N1]} winner`);

    document.getElementById('item' + N1).style.background = '#000';
    document.getElementById('item' + N1).style.color = 'gold';

    document.getElementById('item' + N2).style.background = '#000';
    document.getElementById('item' + N2).style.color = 'gold';


    document.getElementById('item' + N3).style.background = '#000';
    document.getElementById('item' + N3).style.color = 'gold';

  setInterval(function(){titel.text('Another Round')  } ,1000);
